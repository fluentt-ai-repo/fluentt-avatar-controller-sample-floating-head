    ...
    public class FluentTAvatarControllerFloatingHeadEditor : UnityEditor.Editor
    {
        ...
        */
        ...
        private void DrawEyeBlinkSettings()
        {
            ...
            {
                var controller = (FluentTAvatarControllerFloatingHead)target;
                var newClip = CreateDefaultBlinkClip();

                var blinkClipField = typeof(FluentTAvatarControllerFloatingHead).GetField("blinkClip",
                    System.Reflection.BindingFlags.Public | System.Reflection.BindingFlags.Instance);
                blinkClipField?.SetValue(controller, newClip);

                EditorUtility.SetDirty(controller);
                serializedObject.Update();
                Debug.Log("[FluentTAvatarControllerFloatingHead] Created default blink clip with ARKit eyeBlinkLeft/Right");
            }
            EditorGUILayout.EndHorizontal();
